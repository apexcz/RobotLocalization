...
maps = cell(1,1); %needed for making jagged arrays
...
%noiseLevel(:,1) = [0,0,0]; %no noise
 noiseLevel(:,1) = [1,0.001,0.0005]; %all the noise
...
if(strcmp(md5(strcat(pwd,'\BotSim.m')), '8D3E7E7E8AECDF2B49A8B29648DAE1B9') ==0)
    ...
    ResultsTable = table(averageCompletionTime, averageDisFromTgt, averagePathLength, percentCollision,'RowNames',{'Map1'})
    %;'Map2';'Map3'
end